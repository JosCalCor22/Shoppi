...
function GroceriesPage () {
  ...
  useEffect(() => {
    fetch(`${URLAPI}/category/groceries`)
    ...
    <section className='flex justify-center text-center mb-4'>
      <Layout>
        <section className='flex flex-col items-center'>
          <h2 className='text-3xl w-full font-bold my-4 pb-1 mb-5 border-b-2 border-dotted border-[#351e1a]'>Groceries</h2>
